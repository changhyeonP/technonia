...
/* Actual period: 7.066666666666666e-7 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xd4,
  .duty_cycle_counts = 0x6a, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
